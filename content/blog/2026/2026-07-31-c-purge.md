...
[VACUUM Cursor vscdb](/blog/2026/2026-07-31-c-purge-cursor-state-before-vacuum.png)
...
头像 → 设置 → 通用/存储 → 清理缓存
```
![飞书缓存位置](/blog/2026/2026-07-31-c-purge-image-462.png)
再把下载目录和文件保存路径改到：
...
> TODO...
### WPS
![比较坑的是，WPS的存储管理并不在点击头像的个人中心中](/blog/2026/wps.png)

![这里我已经修改了文档备份和云文档缓存的保存路径](/blog/2026/2026-07-31-c-purge-image-472.png)
