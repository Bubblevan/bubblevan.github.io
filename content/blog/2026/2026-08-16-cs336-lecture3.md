---
schema: bubblevan/v1
id: blog-20260816-cs336-lecture3
content_kind: blog
title: CS336 Lecture 3：现代 Transformer 架构、训练稳定性与推理系统
date: 2026-08-16
updated: 2026-08-16
status: draft
visibility: public
summary: 梳理现代 decoder-only Transformer 的架构设计、训练稳定性与推理系统，从 Pre-Norm、RMSNorm、RoPE、SwiGLU 到 GQA 和 KV cache。
topics: [CS336, Transformer, RMSNorm, RoPE, SwiGLU, GQA]
projects: [cs336]
---
...
[
\boxed{\text{在预算固定的情况下，模型究竟应该怎么设计？}}
]

你千万不要把这堂课理解成：

> Transformer = Attention + FFN，我已经知道了。

2017 年原始 Transformer 和今天 decoder-only LLM 的“标准配方”已经明显不同了。

你可以粗略把现代 dense LLM block 想成：
...
而 **CS336 A1 官方 reference interface 恰恰就是这个体系**：pre-norm Transformer block、RMSNorm、SwiGLU、RoPE，而且 RoPE 的维度明确是 `d_model // num_heads`。([GitHub][2])
...
# 1. Transformer Architecture 其实是在设计一条“信息高速公路”
...
而且到这里，A1 里 **Linear / Embedding → RMSNorm → SwiGLU → Attention → RoPE → TransformerBlock → TransformerLM** 这条实现链，理论上已经全部接起来了。([Stanford CS336][1])

[1]: https://stanford-cs336.github.io/ "Stanford CS336 | Language Modeling from Scratch"
[2]: https://github.com/stanford-cs336/assignment1-basics/blob/main/tests/adapters.py "assignment1-basics/tests/adapters.py at main · stanford-cs336/assignment1-basics · GitHub"
[3]: https://arxiv.org/html/2408.00118v1 "Gemma 2: Improving Open Language Models at a Practical Size"
[4]: https://arxiv.org/abs/1910.07467 "[1910.07467] Root Mean Square Layer Normalization"
[5]: https://arxiv.org/abs/2104.09864 "[2104.09864] RoFormer: Enhanced Transformer with Rotary Position Embedding"
[6]: https://arxiv.org/html/2503.19786v1 "Gemma 3 Technical Report"
[7]: https://arxiv.org/abs/2002.05202 "[2002.05202] GLU Variants Improve Transformer"
[8]: https://ar5iv.labs.arxiv.org/html/2204.02311 "[2204.02311] PaLM: Scaling Language Modeling with Pathways"
[9]: https://arxiv.org/abs/2010.04245 "[2010.04245] Query-Key Normalization for Transformers"
[10]: https://arxiv.org/abs/2305.13245 "[2305.13245] GQA: Training Generalized Multi-Query Transformer Models from Multi-Head Checkpoints"
