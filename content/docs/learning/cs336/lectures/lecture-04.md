...
$$
\boxed{\text{KV cache memory decreases}}
$$
...
$$
\boxed{\text{all-to-all interaction to compressed recurrent state}}
$$
...
$$
\boxed{\text{all parameters to conditionally selected parameters}}
$$
