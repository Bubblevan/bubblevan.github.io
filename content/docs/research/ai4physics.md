...
我大二科研所接触的 AI for Science 相关研究，就是深度学习加速晶体力常数预测：基于等变图神经网络与自动微分的AI4Science实践。

当时的学长告诉我，人工智能的重要三角：算法算力数据，前者需要智商卷，中间需要资源，而后者我们刚好有物院的独家数据，因此可以一起来做一点收尾。但是最后虽然被证明收敛不好，这仍是我科研工作，或者说pytorch深度学习的第一个入门里程碑。
