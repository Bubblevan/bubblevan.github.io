...
<NoteBlock title="Optimal policy learning by Sarsa">
...
<NoteBlock title="Algorithm 7.2: Optimal policy learning via Q-learning (on-policy version)">
...
<NoteBlock title="Algorithm 7.3: Optimal policy learning via Q-learning (off-policy version)">
