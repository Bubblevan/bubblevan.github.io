...
<BrowserWindow url="http://localhost:5173">
  <div>
    <img src={require('@site/static/img/react/react2.png').default} alt="React 项目预览" />
  </div>
</BrowserWindow>
...
<CollapsibleBlock title="XML？" defaultExpanded={false}>
...
<BrowserWindow url="http://localhost:5173">
  <div>
    <img src={require('@site/static/img/react/react3.png').default} alt="React 计数器示例" />
  </div>
</BrowserWindow>
